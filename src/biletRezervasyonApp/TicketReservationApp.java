 ...
 */
        public class TicketReservationApp {
            public static void main(String[] args) {
                ...
                //1. bilet rezervasyonu yapacagimiz bir otobüse ihtiyacimiz
                Bus bus =new Bus("34 ASD 789");
           //2.Bilet objesini olusturalim
                Ticket bilet=new Ticket();
                 //7Uygulamayi baslatalim
                start(bus,bilet);
            ...
            private static void start(Bus bus, Ticket bilet) {
                ...
                int select; //Cikis icin 0 seciniz
                ...
                do{
                    ...
                    System.out.println(bus.seats); // mevcut koltuk nolari : "1","2",..."32"
                    String seat=inp.next();

                    //secilen koltuk no listede var mi, rezerve edilmis mi?
                    ...
                    if (age>0 && distance>0 && (type==1||type==2)&& !isReserved){
                        //koltuk no reserve olacagi icin listeden cikaralim
                       ...
                       // bilet.printTicket(bus);
                        ...
                        System.out.println("Gecersiz giris yaptiiz");
                    }
                    System.out.println("yeni islem icin bir sayi girin, CIKIS icin 0 giriniz: ");
                    select=inp.nextInt();
